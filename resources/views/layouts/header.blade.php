...
<header class="main-header">
  ...
  <nav class="navbar navbar-static-top">
        ...
        <li class="dropdown user user-menu">
          ...
          <ul class="dropdown-menu">
            ...
            <li class="user-header">
              <img src="{{ asset('dist/img/homecarlogo1.jpg') }}" class="img-circle" alt="User Image">
              <p>
                {{ Auth::user()->name }}
    ...
    <div class="navbar-custom-menu">
      <ul class="nav navbar-nav">
        <li>
          <a class="btn btn-block active" href="../../../../Projectleasing/public/home">
            <i class="fa fa-sitemap "></i> ระบบลิสซิ่ง
          </a>
        </li>
      </ul>
    </div>
